...
| 2026-08-04 | campaign closure | **CONFIRMED CLOSED.** Two real services (streams servers, fra+ewr) deployed, published, and passed the full 20-check field gate + SDK WAN smoke through their edges. This ticket is done. |

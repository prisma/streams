...
- Managed-cell serving now has a strict bounded directory, deterministic
  ...
  same-generation poison handling, last-known-good reads, and recovery.
...
4. Prove the implemented multi-cell placement/control plane against real
   ...
   documented cell/tenant counts, add independently drilled recovery for the
   global registry authority, and implement the fenced cross-cell move before
   any production rebalancing wave.

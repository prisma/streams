...
4. Prove the implemented multi-cell placement/control plane against real
   provider IAM policies (including denied cross-cell writes), run it at the
   documented cell/tenant counts, exercise the bounded registry-union recovery

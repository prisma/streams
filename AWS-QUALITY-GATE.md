...
1. Add the remaining account/per-stream quota dimensions and an independent
   security review.
2. Add abandoned-generation retention/GC, sibling merge, per-stream hot-share
   enforcement, and an explicit storage-format migration/rollback plan.

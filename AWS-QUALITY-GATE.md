...
- Managed-cell serving now has a strict bounded directory, deterministic
  ...
  decrypted read from recovery storage alone.
...
4. Prove the implemented multi-cell placement/control plane against real
   ...
   against independent providers, and implement the fenced cross-cell move
   before any production rebalancing wave.

...
- Managed-cell serving now has a strict bounded directory, deterministic
  ...
  completion response, and restores the moved target point.
...
4. Prove the implemented multi-cell placement/control plane against real
   ...
   against independent providers, and add retention-qualified cleanup of
   fenced source copies before any high-volume production rebalancing wave.

...
default schema/search/rollup registry on JSON append. `git-repo` owns
...
Today, `git-repo` uses this model to own:

- `git-repo` profile validation and stored profile config

...
Every extracted application file is below 1,000 lines and every function below 200, enforced by the fixed-baseline architecture gate. The refactor introduces no serialization of internal outcomes. This is a source-level copy/ownership analysis, not an allocation or latency benchmark.

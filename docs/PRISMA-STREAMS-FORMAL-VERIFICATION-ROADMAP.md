...
All items below are **planned**. “Validate” states the intended obligation; it is not a claim that the current code has already satisfied it. Source paths identify the initial review owner. Existing invariant IDs identify requirements to reconcile and refine, not proof receipts.

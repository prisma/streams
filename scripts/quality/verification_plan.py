...
def plan(paths, visibility_only=(), production_unchanged=()):
    ...
    codec = any(p.startswith(('src/crypto', 'src/postings', 'src/product_cursor', 'src/application/read_', 'src/shard/record', 'src/queue', 'src/rollup/allocation')) for p in implementation)

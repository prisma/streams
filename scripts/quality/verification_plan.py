...
def plan(paths, visibility_only=()):
    ...
    codec = any(p.startswith(('src/crypto', 'src/postings', 'src/application/read_', 'src/shard/record', 'src/rollup/allocation', 'src/rollup/storage')) for p in implementation)
